...
## What to expect when starting a print

With v1.0.1, a new print should normally transition like this:

```text
White breathing -> orange/red heating -> green progress breathing
```

Heating remains visible during the initial warm-up. Once the commanded bed and hotend temperatures are within 2 C of target, the bridge switches to green print-progress breathing. Normal small temperature recovery later in the print stays green.
